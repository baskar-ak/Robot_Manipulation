...
CUP_BODY_PATH_STR = "/World/scene/SM_Mug_A2_red"

# Jaw rigid body (Body0)
JAW_BODY_PATH_STR = "/World/scene/so101_new_calib/moving_jaw_so101_v1_link"

# Where joint will live
JOINTS_XFORM_STR = "/World/scene/so101_new_calib/GraspJoints"
JOINT_PATH_STR   = "/World/scene/so101_new_calib/GraspJoints/cup_grasp_fixed_joint"
